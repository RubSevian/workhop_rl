...
def generate_launch_description():
    ...
    return LaunchDescription([
      ...
      Node(package='terrain_analysis', executable='terrainAnalysis', output='screen', remappings=[('/registered_scan','/cloud_registered')], parameters=[{'worldFrame':'camera_init','vehicleHeight':1.5,'clearingDis':8.0,'noDataObstacle':True}]),
      Node(package='terrain_analysis_ext', executable='terrainAnalysisExt', output='screen', remappings=[('/registered_scan','/cloud_registered')], parameters=[{'worldFrame':'camera_init','vehicleHeight':1.5,'clearingDis':30.0}]),

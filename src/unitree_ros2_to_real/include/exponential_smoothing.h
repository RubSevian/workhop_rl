...
//             gamma(0.5),
//             counter(0),
//             vacillation_tolerance(0)
//     {
//         curr_smoothed_ob.reset();
//         last_smoothed_ob.reset();
//         curr_correction_ob.reset();
//     }
...
//     /** Set the value of 2nd smoothing constant in the range (0, 1) */
//     void set_beta(const T _val)
//     {
//         assert(_val > 0 && _val < 1);
//         beta = _val;
//     }

//     void set_gamma(const T _val)
//     {
//         assert(_val > 0 && _val < 1);
//         gamma = _val;
//     }
...
//         if (0 == counter)
//         {
//             curr_smoothed_ob = _curr_raw_ob;
//         }
//         else if (1 == counter)
//         {
//             curr_correction_ob = _curr_raw_ob - curr_smoothed_ob;

//             last_smoothed_ob = curr_smoothed_ob;

//             curr_smoothed_ob = alpha * _curr_raw_ob + (1 - alpha) * (curr_smoothed_ob + curr_correction_ob);

//             if ((curr_smoothed_ob - last_smoothed_ob).norm() < vacillation_tolerance)
//             {
//                 curr_smoothed_ob = last_smoothed_ob;
//             }
//         }
//         else
//         {

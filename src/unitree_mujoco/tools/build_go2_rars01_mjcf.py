...
def add_runtime_layers(xml_path, joints):
...
def main():
 ...
 with tempfile.TemporaryDirectory() as tmp_string:
  ...
  xml=out/'go2_rars01.xml'; xml.write_text(text); add_runtime_layers(xml,joints)
